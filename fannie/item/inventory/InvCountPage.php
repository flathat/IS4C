...
/*
$aaa = print_r($args,True);
$this->connection->logger("ICP: $query \n$aaa");
*/
        $ret = '<form method="post">
    ...
    */
    ...
    /*
     * EL: Typo "Ehter" to "The"
     * EL: Re Vertical arrangement.
     * EL: Current: does not include ordering or receiving today.
     */
    public function helpContent()
    {
        ...
        $ret .= '
            <p>The page has three sets of fields, with the sets arranged
            vertically on the page.</p>
            <h3>Entering Counts and Pars</h3>
...
The count date & time is automatically updated, too. If that\'s incorrect, go to the vendor count and par
...
sales, and shrink.
<br />The <em>Recalculate</em> of items Ordered or Sold does not include the current day\'s activity.</p>';
        } else {
            $ret .= '<h3>Entering Counts and Pars</h3>
<p>Counts and pars can be entered per-item or per-vendor. To enter information for a single item,
enter its UPC in the first set of fields. To enter information for several items, choose a vendor
from the second set of fields. The optional super department will filter the list to a more manageable
size in the case of larger vendors.</p>
