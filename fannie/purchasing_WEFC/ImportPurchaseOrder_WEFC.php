...
class ImportPurchaseOrder_WEFC extends \COREPOS\Fannie\API\FannieUploadPage 
{
    protected $title = "Fannie - Purchase Order WEFC";
    protected $header = "Upload Purchase Order / Invoice WEFC";

    public $description = '[Purchase Order Import WEFC] loads a vendor purchase order / invoice 
    from a spreadsheet.';
    public $themed = true;
    ...
    public function process_file($linedata, $indexes)
    {
        ...
        $ret .= '<br />';
        $ret .= '<a href="' . $this->config->get('URL') .
            'purchasing' . $this->page_suffix .
            '/ViewPurchaseOrders' . $this->page_suffix . '.php?id=' .
            $orderID . '">View Order</a></p>';
        //was $ret .= '<a href="' . $this->config->get('URL') . 'purchasing/ViewPurchaseOrders.php?id=' . $orderID . '">View Order</a></p>';
        $this->results = $ret;
    ...
    */
    protected function basicForm()
    {
        ...
        action="<?php echo $this->self_page; ?>" 
            id="FannieUploadForm" method="post">
        ...
        <div class="form-group col-sm-6">
            ...
            onclick="location='<?php echo $this->home_page; ?>'; return false;">Home</button>
        </div>
        <?php
