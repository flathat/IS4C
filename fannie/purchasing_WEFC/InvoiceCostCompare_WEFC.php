...
class InvoiceCostCompare_WEFC extends FannieRESTfulPage 
{

    protected $header = 'Compare Costs WEFC';
    protected $title = 'Compare Costs WEFC';

    public $description = '[Invoice Cost Comparison WEFC] reconciles invoice costs against
