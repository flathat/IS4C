...
class PurchasingSearchPage_WEFC extends FannieRESTfulPage 
{
    protected $header = 'Purchase Orders WEFC';
    protected $title = 'Purchase Orders WEFC';

    public $description = '[Search Purchase Orders WEFC] finds orders/invoices containing a given item.';
    ...
    public function get_id_view()
    {
        ...
        while($row = $dbc->fetch_row($res)) {
            $ret .= sprintf('<tr>
                            ...
                            "ViewPurchaseOrders{$this->page_suffix}.php",
        ...
        $ret .= '</table>';
        $ret .= '<button class="btn btn-default" onclick="location=\'PurchasingIndexPage' .
            $this->page_suffix . '.php\'; return false;">Home</button>';
        $ret .= '<p> &nbsp; </p>';
    ...
    {
        $ret = '<form class="form-horizontal" action="PurchasingSearchPage' .
            $this->page_suffix . '.php" method="get">';
        $ret .= '<div class="row">';
