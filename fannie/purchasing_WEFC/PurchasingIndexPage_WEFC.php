...
class PurchasingIndexPage_WEFC extends FannieRESTfulPage 
{
    protected $header = 'Purchase Orders WEFC';
    protected $title = 'Purchase Orders WEFC';

    public $description = '[Purchase Order Menu WEFC] lists purchase order related pages.';

    protected $must_authenticate = true;
    private $page_suffix = '_WEFC';
    ...
    protected function put_handler()
    {
        try {
            ...
            return 'ViewPurchaseOrders' . $this->page_suffix . '.php?init=pending';
        } catch (Exception $ex) {
            return true;
        }
    }
    ...
    protected function get_view()
    {
        ...
        return '<ul>
            <li><a href="ViewPurchaseOrders' . $this->page_suffix .
                '.php">Orders: View, Edit, Receive</a>
            <li><a href="PurchasingSearchPage' . $this->page_suffix .
                '.php">Search for Orders</a>
            <li>Create New Order or Continue Current Order
                <ul>
                <li><a href="EditOnePurchaseOrder' . $this->page_suffix .
                    '.php">For One Vendor</a></li>
                <li><a href="EditManyPurchaseOrders' . $this->page_suffix .
                    '.php">By Item, for One or More Vendors</a></li>
                <!--
                ...
                <li><a href="ScanTransferPage' . $this->page_suffix .
                    '.php">Store Transfer</a></li>
                </ul>
            </li>
            <li>Import Order
                <ul>
                    <li><a href="ManualPurchaseOrderPage' . $this->page_suffix .
                        '.php">Manually</a></li>
                    <li><a href="ImportPurchaseOrder' . $this->page_suffix .
                        '.php">From Spreadsheet</a></li>
                </ul>
            </li>
            <li>Reports
                <ul>
                <!-- li><a href="reports/LocalInvoicesReport' . $this->page_suffix .
                    '.php">Local Invoices</a></li -->
                <li><a href="reports/OutOfStockReport' . $this->page_suffix .
                    '.php">Vendor Out of Stock</a></li>
                    <li><a href="reports/TotalPurchasesReport' . $this->page_suffix .
                    '.php">Orders Placed and Total Purchases</a></li>
                </ul>
            </li>
            </ul>';
