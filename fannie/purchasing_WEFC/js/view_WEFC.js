function fetchOrders(){
	...
	$.ajax({
		url: 'ViewPurchaseOrders_WEFC.php?'+dataStr,
		type: 'get'
    }).done(function(data){
        $('#ordersDiv').html(data);
...
function togglePlaced(orderID){
	...
	$.ajax({
		url: 'ViewPurchaseOrders_WEFC.php?',
		type: 'post',
		data: dataStr
    }).done(function(data){
...
function doExport(orderID){
	window.location = 'ViewPurchaseOrders_WEFC.php?id='+orderID+'&export='+$('#exporterSelect').val();
}

function doSend(orderID){
	window.location = 'ViewPurchaseOrders_WEFC.php?id='+orderID+'&sendAs='+$('#exporterSelect').val();
}
...
function deleteOrder(orderID)
{
    if (confirm('Delete this order?')) {
        $.ajax({
            ...
            location='ViewPurchaseOrders_WEFC.php?init=pending';
        });
    }
}
