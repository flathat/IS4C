...
if (!class_exists('ImportPurchaseOrder_WEFC')) {
    include(dirname(__FILE__) . '/../ImportPurchaseOrder_WEFC.php');
}

class SpartanNashInvoiceImport_WEFC extends ImportPurchaseOrder_WEFC
{
    protected $title = "Fannie - Purchase Order WEFC";
    protected $header = "Upload Purchase Spartan Nash Invoice WEFC";

    public $description = '[Spartan Nash Order Import WEFC] loads a vendor purchase order / invoice 
    from a spreadsheet.';
    public $themed = true;
    private $page_suffix = '';
    private $self_page = '';
