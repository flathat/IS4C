...
class CpwInvoiceImport_WEFC extends FannieRESTfulPage 
{

    public $themed = true;
    protected $header = 'Import CPW Invoice WEFC';
    protected $title = 'Import CPW Invoice WEFC';

    public $description = '[CPW Invoice Import WEFC] is a specialized tool for importing CPW invoices';
