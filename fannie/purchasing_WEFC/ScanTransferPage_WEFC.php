...
class ScanTransferPage_WEFC extends FannieRESTfulPage
{
    protected $header = 'Create Transfer WEFC';
    protected $title = 'Create Transfer WEFC';
    public $description = '[Scan Transfer WEFC] is a tool to build store-transfer purchase orders.';
...
<p>
    <a href="ViewPurchaseOrders{$this->page_suffix}.php?id={$outID}" class="btn btn-default">Outgoing Order</a>
</p>
<p>
    <a href="ViewPurchaseOrders{$this->page_suffix}.php?id={$inID}" class="btn btn-default">Incoming Order</a>
</p>
HTML;
    ...
    protected function post_id_handler()
    {
        ...
        //was:return 'ScanTransferPage.php';
    }
...
<form method="post">
    ...
    <p>
        ...
        <a href="ScanTransferPage{$this->page_suffix}.php" class="btn btn-default btn-reset">Go Back</a>
    </p>
</form>
HTML;
