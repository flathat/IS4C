...
class ManualPurchaseOrderPage_WEFC extends FannieRESTfulPage 
{
    protected $header = 'Purchase Orders WEFC';
    protected $title = 'Purchase Orders WEFC';

    public $description = '[Manual Purchase Order WEFC] is a tool for entering purchase order info
    ...
    public function get_id_view()
    {
        ...
        $this->add_script('js/manual' . $this->page_suffix . '.js');
        //was:$this->addScript('js/manual.js');
