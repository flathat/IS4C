...
class OutOfStockReport_WEFC extends FannieReportPage 
{
    protected $title = 'Out of Stock Report WEFC';
    protected $header = 'Out of Stock Report WEFC';
    public $description = '[Out of Stock Report WEFC] lists item that were ordered from vendors but not received';
    ...
    function fetch_report_data()
    {
        ...
        while ($w = $dbc->fetchRow($res)) {
            ...
            $report[] = array(
                $w['vendorName'],
                $w['placedDate'],
                '<a href="../ViewPurchaseOrders' . $this-page_suffix .
                    '.php?id=' . $w['orderID'] . '">' . $w['vendorInvoiceID'] . '</a>',
                $w['sku'],
                $w['internalUPC'],
                $w['brand'],
                $w['description'],
