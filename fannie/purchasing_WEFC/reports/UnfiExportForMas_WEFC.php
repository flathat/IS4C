...
class UnfiExportForMas_WEFC extends FannieReportPage 
{
    ...
    protected $title = 'UNFI Export For MAS90 WEFC';
    protected $header = 'UNFI Export For MAS90 WEFC';
    public $report_set = 'Finance WEFC';
    public $description = '[MAS Invoice Export WEFC] exports vendor invoices for MAS90.';
    ...
    */
        ...
        while ($codingW = $dbc->fetch_row($codingR)) {
            ...
            $record = array(
                ...
                '<a href="../ViewPurchaseOrders' . $this->page_suffix . '.php?id=' .
                    $codingW['orderID'] . '">' . $codingW['vendorInvoiceID'] . '</a>',
    ...
    function form_content()
    {
        ...
        ob_start();
        ?>
            <form method = "get" action="<?php echo $this->self_page; ?>">
<div class="col-sm-5">
