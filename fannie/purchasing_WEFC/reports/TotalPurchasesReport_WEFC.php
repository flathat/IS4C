 ...
 */
class TotalPurchasesReport_WEFC extends FannieReportPage 
{
    protected $title = 'Total Purchases Report WEFC';
    protected $header = 'Total Purchases Report WEFC';
    public $description = '[Total Purchases Report WEFC] lists all invoice totals from a vendor for a given period';
    public $report_set = 'Purchasing WEFC';
    ...
    function fetch_report_data()
    {
        ...
        while ($w = $dbc->fetchRow($res)) {
            $report[] = array(
                ...
                $w['received'],
                $w['vendorName'],
                '<a href="../ViewPurchaseOrders' . $this->page_suffix . '.php?id=' .
                    $w['orderID'] . '">' . $w['vendorOrderID'] . '</a>',
                '<a href="../ViewPurchaseOrders' . $this->page_suffix . '.php?id=' .
                    $w['orderID'] . '">' . $w['vendorInvoiceID'] . '</a>',
                sprintf('%s', $w['ttl']),
            );
        }
