...
*********************************************************************************/
/* TODO
 * 12Nov2015 Mostly superseded by the new one that does the things below:
 *           (This one may become obsolete and be deleted.)
...
class ActivityReportSimple extends FannieReportPage 
{
    public $themed = true;
    ...
    protected $title = "Fannie : Coop Cred Simple Activity Report";
    protected $header = "Coop Cred Simple Activity Report";
