...
HTML;
    ...
    public function helpContent()
    {
        ...
        if ($this->config->get('COOP_ID') == 'WEFC_Toronto') {
            $ret .= "<p>";
            $ret .= "Shows quantities (by units and cases)
                of items for the chosen Vendor,
                in the chosen Super Department
                that have been sold during the period.
                ";
            $ret .=  "</p>";
            $ret .= "<p>";
            $ret .= "For each item shows whether it is currently on sale
                and whether it is on an upcoming sale and
                when that sale starts.
                ";
            $ret .=  "</p>";
        }
