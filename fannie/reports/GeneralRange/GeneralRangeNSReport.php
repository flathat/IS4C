...
class GeneralRangeNSReport extends FannieReportPage 
{
    public $description = '[General Range In-House Report] lists tenders, sales, discounts, and taxes for a given 
                    range of dates. Includes WEFC in-house accounts, which you probably don\'t want it to.';
    public $report_set = 'Sales Reports';
    public $themed = true;

    protected $title = "Fannie : General Range with-in-house Report";
    protected $header = "General Range with-in-house Report";
    ...
    {
        return '<p>WEFC should NOT use this.  Use regular General Range
            instead</p>
            <p>
