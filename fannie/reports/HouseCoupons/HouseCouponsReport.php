...
class HouseCouponsReport extends FannieReportPage {

    public $description = '[House Coupons] lists house coupons (issued by the store) totals by UPC for a given date range.';

    protected $title = "Fannie : House Coupons Report";
    protected $header = "House Coupons Report";
    ...
    public function form_content()
    {
        ...
        ob_start();
        ?>
<form action=HouseCouponsReport.php method=get>
