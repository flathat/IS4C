...
HTML;
    ...
    protected function showBatchDisplay($id, $order='natural')
    {
        ...
        */
        ...
        $ret .= "<a href=\"\" onclick=\"batchEdit.generateTags($id); return false;\" " .
            "title=\"Do this before 'Print Shelf Tags'. See Help.\"" .
            ">1. Auto-tag</a> | ";
        $ret .= "<a href=\"{$FANNIE_URL}admin/labels/BatchShelfTags.php?batchID%5B%5D=$id\">2. Print Shelf Tags</a> || ";
        if ($cpCount > 0) {
...
HTML;
    ...
    public function helpContent()
    {
        return '<p>Add one or more items to the batch. Enter a UPC by default or check
            ...
            You must do this in order to make shelf tags available for printing,
            i.e. to make the batch appear in the "Batch Shelf Tags" tab on the
            "Print Shelf Tags" page.</p>
            <p><em>Print shelf tags</em> of course shows the actual tags.</p>
