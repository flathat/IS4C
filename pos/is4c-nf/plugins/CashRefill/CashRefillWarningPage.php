...
class CashRefillWarningPage extends InputCorePage 
{
    ...
    function preprocess()
    {
        if (isset($_REQUEST['reginput'])){
            ...
            CoreLocal::set('cashRefillSaveInput','');
            $qstr = '?reginput=' . urlencode(CoreLocal::get('cashRefillSaveInput')) . '&repeat=1';
